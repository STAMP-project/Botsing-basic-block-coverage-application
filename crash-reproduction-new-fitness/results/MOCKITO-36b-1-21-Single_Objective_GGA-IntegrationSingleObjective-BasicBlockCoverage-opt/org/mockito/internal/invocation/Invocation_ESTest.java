...
public class Invocation_ESTest extends Invocation_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      Invocation invocation0 = new Invocation(isInstanceOf0, mockitoMethod0, objectArray0, 1, realMethod0);
      ...
      doReturn((Class) null).when(mockitoMethod1).getReturnType();
      doReturn(false).when(mockitoMethod1).isVarArgs();
      Invocation invocation1 = new Invocation(invocation0, mockitoMethod1, objectArray0, (-474), (RealMethod) null);
