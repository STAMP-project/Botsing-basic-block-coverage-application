...
public class MultiDirectional_ESTest extends MultiDirectional_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      MultiDirectional multiDirectional1 = new MultiDirectional((-998.43), (-406.6));
      MultiDirectional multiDirectional2 = new MultiDirectional();
      multiDirectional2.setMaxIterations((-1661));
      ...
      try { 
        ...
        fail("Expecting exception: OptimizationException");
         ...
         //
         // org.apache.commons.math.MaxIterationsExceededException: Maximal number of iterations (-1,661) exceeded
         //
