...
public class DirectSearchOptimizer_ESTest extends DirectSearchOptimizer_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      doubleArray0[0] = 3031.551;
      multiDirectional0.setMaxIterations((-1736));
      doubleArray0[1] = 0.0;
      doubleArray0[2] = Double.NaN;
      doubleArray0[3] = 3221.227;
      doubleArray0[4] = 527.9;
      boolean boolean0 = false;
      RealPointValuePair realPointValuePair0 = new RealPointValuePair(doubleArray0, 3221.227, false);
      RealPointValuePair realPointValuePair1 = new RealPointValuePair(doubleArray0, 2111.532);
      ...
      try { 
        ...
        fail("Expecting exception: OptimizationException");
         ...
         //
         // org.apache.commons.math.MaxIterationsExceededException: Maximal number of iterations (-1,736) exceeded
         //
