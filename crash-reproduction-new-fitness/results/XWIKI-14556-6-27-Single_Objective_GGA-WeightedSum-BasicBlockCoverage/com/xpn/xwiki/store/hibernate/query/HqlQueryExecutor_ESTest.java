...
public class HqlQueryExecutor_ESTest extends HqlQueryExecutor_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      DefaultQuery defaultQuery0 = new DefaultQuery("concat", "concat", hqlQueryExecutor0);
      Query query0 = defaultQuery0.bindValue("concat", (Object) "concat");
      hqlQueryExecutor0.checkAllowed(query0);
      DefaultQuery defaultQuery1 = new DefaultQuery("e8u+psdfx", "e8u+psdfx", hqlQueryExecutor0);
      DefaultQuery defaultQuery2 = new DefaultQuery("order by e8u+psdfxnbu$i", hqlQueryExecutor0);
      defaultQuery1.bindValue("Execute HQL query [{}]", (Object) defaultQuery2);
      hqlQueryExecutor0.checkAllowed(defaultQuery1);
      SessionImplementor sessionImplementor0 = mock(SessionImplementor.class, new ViolatedAssumptionAnswer());
      ParameterMetadata parameterMetadata0 = new ParameterMetadata((OrdinalParameterDescriptor[]) null, (Map) null);
      QueryImpl queryImpl0 = new QueryImpl("escapeLikeParameters", sessionImplementor0, parameterMetadata0);
      Query query1 = defaultQuery0.setOffset(1231);
      // Undeclared exception!
      hqlQueryExecutor0.populateParameters(queryImpl0, query1);
  }
}
