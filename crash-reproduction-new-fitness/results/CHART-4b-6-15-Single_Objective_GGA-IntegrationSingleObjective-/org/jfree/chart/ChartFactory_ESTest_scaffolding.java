...
public class ChartFactory_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    ...
    mock(Class.forName("org.jfree.chart.util.TableOrder", false, ChartFactory_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.jfree.data.category.CategoryDataset", false, ChartFactory_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.jfree.data.general.PieDataset", false, ChartFactory_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.jfree.data.statistics.BoxAndWhiskerXYDataset", false, ChartFactory_ESTest_scaffolding.class.getClassLoader()));
