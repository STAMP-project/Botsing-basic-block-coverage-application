...
public class DirectSearchOptimizer_ESTest extends DirectSearchOptimizer_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      int int0 = 2042;
      multiDirectional0.setMaxIterations((-2076));
      GoalType goalType0 = GoalType.MINIMIZE;
      double[] doubleArray0 = new double[6];
      doubleArray0[0] = (double) (-2076);
      doubleArray0[1] = (double) 2042;
      doubleArray0[2] = (-0.7486833782809318);
      doubleArray0[3] = (double) 2042;
      doubleArray0[4] = (-0.7486833782809318);
      doubleArray0[5] = (-82.9313591);
      try { 
        ...
        fail("Expecting exception: OptimizationException");
         ...
         //
         // org.apache.commons.math.MaxIterationsExceededException: Maximal number of iterations (-2,076) exceeded
         //
