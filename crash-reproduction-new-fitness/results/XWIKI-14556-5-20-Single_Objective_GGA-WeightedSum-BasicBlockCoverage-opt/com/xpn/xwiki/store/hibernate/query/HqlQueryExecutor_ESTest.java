...
public class HqlQueryExecutor_ESTest extends HqlQueryExecutor_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      String string0 = ")'hu>yNqG^;1/O4";
      HqlQueryExecutor.isSafeSelect(")'hu>yNqG^;1/O4");
      ...
      CollectionFilterImpl collectionFilterImpl0 = new CollectionFilterImpl("G9N;", xWikiContext0, sessionImplementor0, parameterMetadata0);
      Query query0 = collectionFilterImpl0.setReadOnly(false);
      DefaultQuery defaultQuery0 = new DefaultQuery("power", ")'hu>yNqG^;1/O4", hqlQueryExecutor0);
      // Undeclared exception!
      hqlQueryExecutor0.setNamedParameter(query0, "}SZB", defaultQuery0);
  }
}
