...
public class XWikiHibernateStore_ESTest extends XWikiHibernateStore_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      XWikiHibernateStore xWikiHibernateStore0 = new XWikiHibernateStore("Q:6Sr{`c+{");
      EntityReferenceSerializer<XWikiLink> entityReferenceSerializer0 = (EntityReferenceSerializer<XWikiLink>) mock(EntityReferenceSerializer.class, new ViolatedAssumptionAnswer());
      ...
      DocumentReferenceResolver<XWikiAttachment> documentReferenceResolver0 = (DocumentReferenceResolver<XWikiAttachment>) mock(DocumentReferenceResolver.class, new ViolatedAssumptionAnswer());
      ...
      EntityReferenceSerializer<PoolableConnection> entityReferenceSerializer2 = (EntityReferenceSerializer<PoolableConnection>) mock(EntityReferenceSerializer.class, new ViolatedAssumptionAnswer());
