...
public class HqlQueryExecutor_ESTest extends HqlQueryExecutor_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      hqlQueryExecutor0.completeShortFormStatement("where ");
      Query query0 = null;
      SessionImplementor sessionImplementor0 = mock(SessionImplementor.class, new ViolatedAssumptionAnswer());
      SessionImplementor sessionImplementor1 = mock(SessionImplementor.class, new ViolatedAssumptionAnswer());
      TreeMap<RootComponentManager, NoOpQueryFilter> treeMap0 = new TreeMap<RootComponentManager, NoOpQueryFilter>();
      PersistentSortedMap persistentSortedMap0 = new PersistentSortedMap(sessionImplementor1, treeMap0);
      PersistentSortedMap persistentSortedMap1 = new PersistentSortedMap(sessionImplementor1, persistentSortedMap0);
      ParameterMetadata parameterMetadata0 = new ParameterMetadata((OrdinalParameterDescriptor[]) null, persistentSortedMap1);
      CollectionFilterImpl collectionFilterImpl0 = new CollectionFilterImpl("where ", "where ", sessionImplementor0, parameterMetadata0);
      Query query1 = collectionFilterImpl0.setComment("order by org.apache.struts.action.cancel");
      // Undeclared exception!
      hqlQueryExecutor0.setNamedParameter(query1, "where ", "where ");
  }
}
