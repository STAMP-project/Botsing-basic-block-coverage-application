...
public class DirectSearchOptimizer_ESTest extends DirectSearchOptimizer_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      multiDirectional0.setMaxIterations((-2604));
      int int0 = (-438);
      MultiDirectional multiDirectional1 = new MultiDirectional(386, 1498.1196113883);
      multiDirectional0.getConvergenceChecker();
      MultiDirectional multiDirectional2 = new MultiDirectional();
      multiDirectional2.setMaxIterations((-2604));
      try { 
        multiDirectional2.iterateSimplex(comparator0);
        fail("Expecting exception: OptimizationException");
      
      } catch(OptimizationException e) {
         //
         // org.apache.commons.math.MaxIterationsExceededException: Maximal number of iterations (-2,604) exceeded
         //
