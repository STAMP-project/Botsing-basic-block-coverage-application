...
public class XWikiHibernateStore_ESTest extends XWikiHibernateStore_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      XWikiHibernateStore xWikiHibernateStore0 = new XWikiHibernateStore(">GgYS%NYvIZ2{5NDWY");
      EntityReferenceSerializer<StringListProperty> entityReferenceSerializer0 = (EntityReferenceSerializer<StringListProperty>) mock(EntityReferenceSerializer.class, new ViolatedAssumptionAnswer());
      ...
      EntityReferenceSerializer<PropertyClass> entityReferenceSerializer2 = (EntityReferenceSerializer<PropertyClass>) mock(EntityReferenceSerializer.class, new ViolatedAssumptionAnswer());
