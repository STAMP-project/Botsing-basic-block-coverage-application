...
public class CountDocumentFilter_ESTest extends CountDocumentFilter_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      countDocumentFilter0.filterStatement("l!.p<~g;m.awC*'?`", "group by ");
      LinkedList<Object> linkedList0 = new LinkedList<Object>();
      countDocumentFilter0.filterResults(linkedList0);
      countDocumentFilter0.filterStatement("l!.p<~g;m.awC*'?`", "select count(");
      countDocumentFilter0.getOrderByColumns("hql");
      // Undeclared exception!
      countDocumentFilter0.filterStatement("l!.p<~g;m.awC*'?`", "hql");
  }
}
