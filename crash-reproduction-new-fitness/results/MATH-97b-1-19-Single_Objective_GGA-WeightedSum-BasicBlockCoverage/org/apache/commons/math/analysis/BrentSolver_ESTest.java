...
public class BrentSolver_ESTest extends BrentSolver_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      brentSolver0.isSequence(Double.NaN, 577.194, (-2571.206802468167));
      ...
      brentSolver1.isSequence(0.0, (-3623.5518), 0.0);
      brentSolver1.verifySequence((-2571.206802468167), (-1.0), 2265.96012);
      brentSolver1.clearResult();
      // Undeclared exception!
      brentSolver1.solve((-2265.94033557), (-1.0));
  }
}
