...
public class HqlQueryExecutor_ESTest extends HqlQueryExecutor_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      DefaultQuery defaultQuery0 = new DefaultQuery("b'<#^/c.RQ|3jwKL", "(?i)^(xml).*", defaultQueryExecutorManager0);
      SynchronousQueue<SubstituteLoggingEvent> synchronousQueue0 = new SynchronousQueue<SubstituteLoggingEvent>(true);
      SubstituteLogger substituteLogger0 = new SubstituteLogger("b'<#^/c.RQ|3jwKL", synchronousQueue0, false);
