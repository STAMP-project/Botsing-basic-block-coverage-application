...
public class XWikiDocument_ESTest extends XWikiDocument_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      XWikiAttachment xWikiAttachment0 = mock(XWikiAttachment.class, new ViolatedAssumptionAnswer());
      DocumentReference documentReference1 = mock(DocumentReference.class, new ViolatedAssumptionAnswer());
      String string0 = "&#x";
      String string1 = "p|*xl@T5qoz~j)l";
      xWikiDocument0.getXObject(documentReference1, "&#x", "p|*xl@T5qoz~j)l", true);
