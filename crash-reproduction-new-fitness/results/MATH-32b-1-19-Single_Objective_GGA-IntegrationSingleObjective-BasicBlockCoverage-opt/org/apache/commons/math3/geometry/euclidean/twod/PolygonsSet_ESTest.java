...
public class PolygonsSet_ESTest extends PolygonsSet_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      doReturn((SubHyperplane) null).when(hyperplane1).wholeHyperplane();
      polygonsSet0.side(hyperplane1);
      Vector<Euclidean2D> vector0 = polygonsSet0.getBarycenter();
      polygonsSet0.checkPoint(vector0);
      polygonsSet0.getVertices();
      polygonsSet0.computeGeometricalProperties();
      PolygonsSet polygonsSet1 = new PolygonsSet(2713.8153101627527, 1506.925563629487, 2713.8153101627527, 1049.3);
      polygonsSet0.computeGeometricalProperties();
      PolygonsSet polygonsSet2 = new PolygonsSet();
      BSPTree<Euclidean2D> bSPTree1 = new BSPTree<Euclidean2D>(polygonsSet1);
      PolygonsSet polygonsSet3 = polygonsSet0.buildNew(bSPTree1);
