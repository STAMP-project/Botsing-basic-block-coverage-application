...
public class HqlQueryExecutor_ESTest extends HqlQueryExecutor_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      DefaultQuery defaultQuery0 = new DefaultQuery(",zs6|c{qubz)d)pj/", ",zs6|c{qubz)d)pj/", hqlQueryExecutor0);
      ...
      DefaultQuery defaultQuery1 = new DefaultQuery("kt^ldVW#>fT[)X?.G", "kt^ldVW#>fT[)X?.G", hqlQueryExecutor0);
      ...
      countDocumentFilter1.filterStatement("Binding component with path: {}", "Binding component with path: {}");
      defaultQuery1.addFilter(countDocumentFilter1);
