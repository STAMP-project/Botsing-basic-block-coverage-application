...
public class CountDocumentFilter_ESTest extends CountDocumentFilter_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      countDocumentFilter1.getOrderByColumns("ramBytesUsed mismatch : ");
      countDocumentFilter0.filterStatement("Found %s lost segments for identifier %s", "");
      String string0 = "CH changed - making %s segments suspect for identifier %s";
      String string1 = "hql";
      // Undeclared exception!
      countDocumentFilter1.filterStatement("Timeout must be greater than 0", "hql");
  }
}
