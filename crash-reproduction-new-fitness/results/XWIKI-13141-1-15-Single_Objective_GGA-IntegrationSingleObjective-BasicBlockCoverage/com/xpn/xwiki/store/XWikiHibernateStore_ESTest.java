...
public class XWikiHibernateStore_ESTest extends XWikiHibernateStore_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      XWikiHibernateStore xWikiHibernateStore0 = new XWikiHibernateStore("%'/Po??lKy1");
      EntityReferenceSerializer<TextAreaClass> entityReferenceSerializer0 = (EntityReferenceSerializer<TextAreaClass>) mock(EntityReferenceSerializer.class, new ViolatedAssumptionAnswer());
      ...
      DocumentReferenceResolver<XWikiDocument> documentReferenceResolver1 = (DocumentReferenceResolver<XWikiDocument>) mock(DocumentReferenceResolver.class, new ViolatedAssumptionAnswer());
      ...
      EntityReferenceSerializer<LongProperty> entityReferenceSerializer1 = (EntityReferenceSerializer<LongProperty>) mock(EntityReferenceSerializer.class, new ViolatedAssumptionAnswer());
