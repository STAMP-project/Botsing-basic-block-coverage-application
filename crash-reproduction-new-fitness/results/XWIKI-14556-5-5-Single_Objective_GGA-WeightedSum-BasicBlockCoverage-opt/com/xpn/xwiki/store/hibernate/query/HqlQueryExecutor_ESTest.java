...
public class HqlQueryExecutor_ESTest extends HqlQueryExecutor_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      String string0 = "where evc";
      SessionImplementor sessionImplementor0 = mock(SessionImplementor.class, new ViolatedAssumptionAnswer());
      AtomicHashMap.ProxyMode atomicHashMap_ProxyMode0 = AtomicHashMap.ProxyMode.FINE;
      AtomicHashMap<DocumentComponentManager, UserComponentManager> atomicHashMap0 = new AtomicHashMap<DocumentComponentManager, UserComponentManager>(atomicHashMap_ProxyMode0);
      AtomicHashMap<DocumentComponentManager, UserComponentManager> atomicHashMap1 = atomicHashMap0.copy();
      AtomicHashMap<DocumentComponentManager, UserComponentManager> atomicHashMap2 = atomicHashMap1.copy();
      ParameterMetadata parameterMetadata0 = new ParameterMetadata((OrdinalParameterDescriptor[]) null, atomicHashMap2);
      CollectionFilterImpl collectionFilterImpl0 = new CollectionFilterImpl("where evc", countDocumentFilter0, sessionImplementor0, parameterMetadata0);
      Query query0 = collectionFilterImpl0.setTimeout(1);
      // Undeclared exception!
      hqlQueryExecutor0.setNamedParameter(query0, "where evc", atomicHashMap_ProxyMode0);
  }
}
