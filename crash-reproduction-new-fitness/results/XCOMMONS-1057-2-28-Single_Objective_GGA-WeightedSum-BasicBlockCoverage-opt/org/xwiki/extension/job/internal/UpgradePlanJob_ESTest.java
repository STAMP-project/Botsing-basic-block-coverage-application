...
public class UpgradePlanJob_ESTest extends UpgradePlanJob_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      ExtensionId extensionId0 = new ExtensionId("#+Z0z", "Failed to dispose component with role type [{}] and role hint [{}]");
      ExtensionId extensionId1 = new ExtensionId("Failed to resolve remote versions for extension id [{}]", "parsing input stream ");
      extensionId0.compareTo(extensionId1);
      // Undeclared exception!
      upgradePlanJob0.tryInstallExtension(extensionId0, ">vlEk_}~H}HTWwG_h");
  }
}
