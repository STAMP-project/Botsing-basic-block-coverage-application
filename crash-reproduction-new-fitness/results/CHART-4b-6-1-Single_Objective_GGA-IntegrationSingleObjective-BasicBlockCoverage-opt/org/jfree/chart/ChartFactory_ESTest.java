...
public class ChartFactory_ESTest extends ChartFactory_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      String string0 = "";
      String string1 = ".b:2M^OQ3pxw`";
      String string2 = "%vaJ6-:sSrsbHKq,";
      ...
      ChartFactory.createScatterPlot("", ".b:2M^OQ3pxw`", "%vaJ6-:sSrsbHKq,", xYDataset0, plotOrientation0, true, true, true);
  }
}
