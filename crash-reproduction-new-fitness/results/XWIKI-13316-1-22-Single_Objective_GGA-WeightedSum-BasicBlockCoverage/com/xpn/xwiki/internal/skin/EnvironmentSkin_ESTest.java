...
public class EnvironmentSkin_ESTest extends EnvironmentSkin_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      String string0 = "Failed to load skin [{}] properties file";
      ...
      EnvironmentSkin environmentSkin0 = new EnvironmentSkin("Failed to load skin [{}] properties file", internalSkinManager0, internalSkinConfiguration0, logger0, syntaxFactory0, environment0, provider0);
      String string1 = "<:rZb?Emz+f<JS";
      ...
      EnvironmentSkin environmentSkin1 = new EnvironmentSkin("<:rZb?Emz+f<JS", internalSkinManager1, internalSkinConfiguration1, logger1, syntaxFactory1, (Environment) null, provider1);
