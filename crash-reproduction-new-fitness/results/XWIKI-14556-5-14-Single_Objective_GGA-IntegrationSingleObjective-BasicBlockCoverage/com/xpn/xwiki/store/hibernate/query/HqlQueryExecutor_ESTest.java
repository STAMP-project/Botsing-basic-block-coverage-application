...
public class HqlQueryExecutor_ESTest extends HqlQueryExecutor_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      Provider<WikiReference> provider0 = (Provider<WikiReference>) mock(Provider.class, new ViolatedAssumptionAnswer());
      ...
      TreeMap<ContextRootComponentManager, NamedQueryDefinition> treeMap0 = new TreeMap<ContextRootComponentManager, NamedQueryDefinition>();
      ...
      ParameterMetadata parameterMetadata0 = new ParameterMetadata(ordinalParameterDescriptorArray0, persistentSortedMap1);
      CollectionFilterImpl collectionFilterImpl0 = new CollectionFilterImpl("REFMODIFIER", hqlQueryExecutor0, sessionImplementor0, parameterMetadata0);
      PassThroughResultTransformer passThroughResultTransformer0 = (PassThroughResultTransformer)CriteriaSpecification.PROJECTION;
      Query query0 = collectionFilterImpl0.setResultTransformer(passThroughResultTransformer0);
      // Undeclared exception!
      hqlQueryExecutor0.setNamedParameter(query0, (String) null, " does not exist as a named parameter in [");
  }
}
