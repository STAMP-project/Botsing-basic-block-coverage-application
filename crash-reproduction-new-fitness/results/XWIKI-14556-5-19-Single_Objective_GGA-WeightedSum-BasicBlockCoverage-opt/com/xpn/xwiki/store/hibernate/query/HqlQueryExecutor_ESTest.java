...
public class HqlQueryExecutor_ESTest extends HqlQueryExecutor_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      Flag[] flagArray0 = new Flag[3];
      flagArray0[2] = flagArray0[0];
      ...
      CollectionFilterImpl collectionFilterImpl0 = new CollectionFilterImpl("w", languageQueryFilter0, sessionImplementor0, parameterMetadata0);
      SessionImplementor sessionImplementor1 = mock(SessionImplementor.class, new ViolatedAssumptionAnswer());
      CollectionFilterImpl collectionFilterImpl1 = new CollectionFilterImpl("Named queries requires programming right", (Object) null, sessionImplementor1, (ParameterMetadata) null);
      LockMode lockMode0 = LockMode.PESSIMISTIC_FORCE_INCREMENT;
      Query query0 = collectionFilterImpl0.setLockMode("5BV,(aWk^{'>", lockMode0);
      ...
      hqlQueryExecutor0.setNamedParameter(query0, "x", contextualAuthorizationManager0);
  }
}
