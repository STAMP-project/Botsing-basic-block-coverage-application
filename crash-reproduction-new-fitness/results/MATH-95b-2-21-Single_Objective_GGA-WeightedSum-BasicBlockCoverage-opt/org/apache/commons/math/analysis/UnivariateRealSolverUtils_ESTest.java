...
public class UnivariateRealSolverUtils_ESTest extends UnivariateRealSolverUtils_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      double double0 = 0.5;
      UnivariateRealSolverUtils.solve(univariateRealFunction0, (-1.0), 0.5, 0.5);
      UnivariateRealFunction univariateRealFunction1 = mock(UnivariateRealFunction.class, new ViolatedAssumptionAnswer());
      double double1 = 0.0;
      // Undeclared exception!
      UnivariateRealSolverUtils.bracket(univariateRealFunction1, 0.0, (-818.3), (-818.3));
  }
}
