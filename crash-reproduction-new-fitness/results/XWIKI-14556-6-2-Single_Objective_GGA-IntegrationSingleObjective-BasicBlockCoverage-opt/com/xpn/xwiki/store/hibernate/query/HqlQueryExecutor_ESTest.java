...
public class HqlQueryExecutor_ESTest extends HqlQueryExecutor_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      CharacterType characterType0 = CharacterType.INSTANCE;
      ContextualAuthorizationManager contextualAuthorizationManager0 = mock(ContextualAuthorizationManager.class, new ViolatedAssumptionAnswer());
      EntityMode entityMode0 = EntityMode.MAP;
      ...
      DefaultQuery defaultQuery0 = new DefaultQuery(",,-2*jp.>*q'", hqlQueryExecutor0);
      ...
      CollectionFilterImpl collectionFilterImpl0 = new CollectionFilterImpl("xbL-%", entityMode0, sessionImplementor0, parameterMetadata0);
      collectionFilterImpl0.setFetchSize(1116);
      DefaultQuery defaultQuery1 = new DefaultQuery("gtrapprox", "gtrapprox", hqlQueryExecutor0);
      DefaultQuery defaultQuery2 = new DefaultQuery(",,-2*jp.>*q'", "`L", hqlQueryExecutor0);
      Query query0 = defaultQuery0.bindValue("P21vQt&~YE", (Object) defaultQuery2);
