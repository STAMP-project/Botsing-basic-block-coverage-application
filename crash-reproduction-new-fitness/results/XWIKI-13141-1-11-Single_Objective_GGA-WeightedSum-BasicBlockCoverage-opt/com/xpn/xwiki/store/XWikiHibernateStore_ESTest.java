...
public class XWikiHibernateStore_ESTest extends XWikiHibernateStore_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      DocumentReferenceResolver<BaseStringProperty> documentReferenceResolver0 = (DocumentReferenceResolver<BaseStringProperty>) mock(DocumentReferenceResolver.class, new ViolatedAssumptionAnswer());
      ...
      DocumentReferenceResolver<Byte> documentReferenceResolver1 = (DocumentReferenceResolver<Byte>) mock(DocumentReferenceResolver.class, new ViolatedAssumptionAnswer());
      ...
      EntityReferenceSerializer<Long> entityReferenceSerializer2 = (EntityReferenceSerializer<Long>) mock(EntityReferenceSerializer.class, new ViolatedAssumptionAnswer());
      ...
      Provider<Long> provider0 = (Provider<Long>) mock(Provider.class, new ViolatedAssumptionAnswer());
