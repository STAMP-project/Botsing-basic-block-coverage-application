...
public class AbstractMimeMessageIterator_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.xpn.xwiki.store.hibernate.HibernateSessionFactory", false, AbstractMimeMessageIterator_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.xpn.xwiki.store.migration.DataMigrationManager", false, AbstractMimeMessageIterator_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("javax.inject.Provider", false, AbstractMimeMessageIterator_ESTest_scaffolding.class.getClassLoader()));
    ...
    mock(Class.forName("org.xwiki.component.manager.ComponentManager", false, AbstractMimeMessageIterator_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.xwiki.context.Execution", false, AbstractMimeMessageIterator_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.xwiki.logging.LoggerManager", false, AbstractMimeMessageIterator_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.xwiki.model.reference.DocumentReferenceResolver", false, AbstractMimeMessageIterator_ESTest_scaffolding.class.getClassLoader()));
