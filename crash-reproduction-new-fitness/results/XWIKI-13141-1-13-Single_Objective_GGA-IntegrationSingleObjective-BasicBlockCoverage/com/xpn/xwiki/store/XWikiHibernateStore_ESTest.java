...
public class XWikiHibernateStore_ESTest extends XWikiHibernateStore_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      EntityReferenceSerializer<DefaultTreeCellRenderer> entityReferenceSerializer0 = (EntityReferenceSerializer<DefaultTreeCellRenderer>) mock(EntityReferenceSerializer.class, new ViolatedAssumptionAnswer());
      ...
      DocumentReferenceResolver<Double> documentReferenceResolver1 = (DocumentReferenceResolver<Double>) mock(DocumentReferenceResolver.class, new ViolatedAssumptionAnswer());
      ...
      EntityReferenceSerializer<PropertyClass> entityReferenceSerializer1 = (EntityReferenceSerializer<PropertyClass>) mock(EntityReferenceSerializer.class, new ViolatedAssumptionAnswer());
      ...
      EntityReferenceSerializer<XWikiLink> entityReferenceSerializer2 = (EntityReferenceSerializer<XWikiLink>) mock(EntityReferenceSerializer.class, new ViolatedAssumptionAnswer());
