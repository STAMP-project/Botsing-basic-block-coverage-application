...
public class XWikiHibernateStore_ESTest extends XWikiHibernateStore_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      DocumentReferenceResolver<LargeStringProperty> documentReferenceResolver0 = (DocumentReferenceResolver<LargeStringProperty>) mock(DocumentReferenceResolver.class, new ViolatedAssumptionAnswer());
      ...
      EntityReferenceSerializer<Float> entityReferenceSerializer2 = (EntityReferenceSerializer<Float>) mock(EntityReferenceSerializer.class, new ViolatedAssumptionAnswer());
      ...
      try { 
        xWikiHibernateStore0.saveXWikiDoc(xWikiDocument0, xWikiContext3, true);
