...
public class FastDateParser_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.text.ParsePosition", false, FastDateParser_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.TimeZone", false, FastDateParser_ESTest_scaffolding.class.getClassLoader()));
  }
}
