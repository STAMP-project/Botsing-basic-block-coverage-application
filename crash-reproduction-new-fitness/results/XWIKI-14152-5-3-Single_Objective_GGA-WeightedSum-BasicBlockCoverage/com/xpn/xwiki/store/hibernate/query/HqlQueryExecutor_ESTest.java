...
public class HqlQueryExecutor_ESTest extends HqlQueryExecutor_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      HqlQueryExecutor.isSafeSelect("8yt=$ugb1 6}");
      ContextualAuthorizationManager contextualAuthorizationManager0 = mock(ContextualAuthorizationManager.class, new ViolatedAssumptionAnswer());
      Execution execution0 = mock(Execution.class, new ViolatedAssumptionAnswer());
      HibernateSessionFactory hibernateSessionFactory0 = mock(HibernateSessionFactory.class, new ViolatedAssumptionAnswer());
      HqlQueryExecutor.isSafeSelect("8yt=$ugb1 6}");
      HqlQueryExecutor.isSafeSelect("*b%%Cb.nt0NvZiFi");
      PersistentList persistentList0 = new PersistentList();
      HqlQueryExecutor.isSafeSelect("cL");
      ...
      DefaultQuery defaultQuery0 = new DefaultQuery("G_4HAp9-l{qe-xAe`", "order by /5", hqlQueryExecutor0);
      defaultQuery0.setLimit((-4579));
      ...
      SubstituteLogger substituteLogger0 = new SubstituteLogger("/", linkedBlockingQueue0, false);
      ...
      ((DefaultQuery) secureQuery0).setOffset((-2698));
