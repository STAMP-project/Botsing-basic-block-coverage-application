...
public class HqlQueryExecutor_ESTest extends HqlQueryExecutor_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      DefaultQuery defaultQuery0 = new DefaultQuery("#IZZ", hqlQueryExecutor0);
      defaultQuery0.setOffset(197);
      defaultQuery0.bindValue("#IZZ");
      Query query0 = defaultQuery0.setLimit(100000);
      ...
      OrdinalParameterDescriptor ordinalParameterDescriptor0 = new OrdinalParameterDescriptor((-117644756), (Type) null, 100000);
      ...
      CollectionFilterImpl collectionFilterImpl0 = new CollectionFilterImpl("q+ ", "q+ ", sessionImplementor0, parameterMetadata0);
      collectionFilterImpl0.setComment("order by ye\". o'w@gx7:c*fb+");
