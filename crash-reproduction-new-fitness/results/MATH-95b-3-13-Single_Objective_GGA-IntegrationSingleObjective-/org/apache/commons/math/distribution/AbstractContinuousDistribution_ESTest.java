...
public class AbstractContinuousDistribution_ESTest extends AbstractContinuousDistribution_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      doReturn(0.0).when(gammaDistribution0).cumulativeProbability(anyDouble());
      doReturn(0.0, 0.0).when(gammaDistribution0).getAlpha();
      doReturn(0.0).when(gammaDistribution0).getBeta();
      ChiSquaredDistributionImpl chiSquaredDistributionImpl0 = new ChiSquaredDistributionImpl(1.0E-6, gammaDistribution0);
      chiSquaredDistributionImpl0.cumulativeProbability(1.0E-6);
