...
public class EnvironmentSkin_ESTest extends EnvironmentSkin_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      String string0 = "Access to document {0} has been denied to user {1}";
      ...
      EnvironmentSkin environmentSkin0 = new EnvironmentSkin("Access to document {0} has been denied to user {1}", internalSkinManager0, internalSkinConfiguration0, logger0, syntaxFactory0, environment0, provider0);
      ...
      EnvironmentSkin environmentSkin1 = new EnvironmentSkin("k`K", internalSkinManager1, internalSkinConfiguration1, logger1, syntaxFactory1, (Environment) null, provider1);
