...
public class MultiDirectional_ESTest extends MultiDirectional_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      multiDirectional0.setMaxIterations((-408));
      ...
      try { 
        multiDirectional0.iterateSimplex(comparator2);
        fail("Expecting exception: OptimizationException");
      
      } catch(OptimizationException e) {
         //
         // org.apache.commons.math.MaxIterationsExceededException: Maximal number of iterations (-408) exceeded
         //
