...
public class EnvironmentSkin_ESTest extends EnvironmentSkin_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      EnvironmentSkin environmentSkin0 = new EnvironmentSkin("skin.properties", (InternalSkinManager) null, internalSkinConfiguration0, logger0, syntaxFactory0, (Environment) null, provider0);
      environmentSkin0.createResource("skin.properties", "skin.properties");
      String string0 = "s.LlAxAt:X";
      environmentSkin0.createResource("q7N\"olgy`kxW@Ofa8i", "s.LlAxAt:X");
