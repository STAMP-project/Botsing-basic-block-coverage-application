...
public class MultiDirectional_ESTest extends MultiDirectional_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      double double0 = 0.0;
      double double1 = (-3745.0);
      MultiDirectional multiDirectional0 = new MultiDirectional(0.0, (-3745.0));
      int int0 = (-109);
      multiDirectional0.setMaxIterations((-109));
      ...
      try { 
        ...
        fail("Expecting exception: OptimizationException");
         ...
         //
         // org.apache.commons.math.MaxIterationsExceededException: Maximal number of iterations (-109) exceeded
         //
