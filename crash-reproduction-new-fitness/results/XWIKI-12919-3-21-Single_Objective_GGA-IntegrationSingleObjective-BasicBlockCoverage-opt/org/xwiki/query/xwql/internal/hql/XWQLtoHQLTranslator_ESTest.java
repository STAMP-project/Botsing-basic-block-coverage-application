...
public class XWQLtoHQLTranslator_ESTest extends XWQLtoHQLTranslator_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      String string0 = "Cannot add a template to document {0} because it already has content";
      try { 
        xWQLtoHQLTranslator0.translate("Cannot add a template to document {0} because it already has content");
