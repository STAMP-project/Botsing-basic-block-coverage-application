...
public class DateTimeParserBucket_ESTest extends DateTimeParserBucket_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      dateTimeParserBucket0.restoreState("^BME$`ma>*GJd,D#?");
      String string0 = " * ";
      dateTimeParserBucket0.restoreState(" * ");
      DateTimeFieldType dateTimeFieldType0 = DateTimeFieldType.dayOfWeek();
      dateTimeParserBucket0.saveField(dateTimeFieldType0, 28181250);
      String string1 = "`+Zb<:#sdf=";
      // Undeclared exception!
      dateTimeParserBucket0.computeMillis(false, "`+Zb<:#sdf=");
  }
}
