...
public class DefaultContentParser_ESTest extends DefaultContentParser_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      Provider<ChronoLocalDate> provider1 = (Provider<ChronoLocalDate>) mock(Provider.class, new ViolatedAssumptionAnswer());
      Injector.inject(defaultContentParser1, (Class<?>) DefaultContentParser.class, "componentManagerProvider", (Object) provider1);
      EntityReferenceSerializer<DefaultTableModel> entityReferenceSerializer1 = (EntityReferenceSerializer<DefaultTableModel>) mock(EntityReferenceSerializer.class, new ViolatedAssumptionAnswer());
      ...
      defaultContentParser0.parse("IC#cnbO*`]>X<ZxS", syntax0, entityReference0);
  }
}
