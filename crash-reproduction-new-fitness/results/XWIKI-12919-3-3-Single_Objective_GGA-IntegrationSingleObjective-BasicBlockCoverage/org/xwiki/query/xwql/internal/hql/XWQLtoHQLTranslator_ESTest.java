...
public class XWQLtoHQLTranslator_ESTest extends XWQLtoHQLTranslator_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      xWQLtoHQLTranslator0.getPrinter(queryContext2);
      QueryContext queryContext3 = mock(QueryContext.class, new ViolatedAssumptionAnswer());
      xWQLtoHQLTranslator0.getPrinter(queryContext3);
      QueryContext queryContext4 = mock(QueryContext.class, new ViolatedAssumptionAnswer());
      xWQLtoHQLTranslator0.getPrinter(queryContext4);
      xWQLtoHQLTranslator0.getOutputLanguage();
      try { 
