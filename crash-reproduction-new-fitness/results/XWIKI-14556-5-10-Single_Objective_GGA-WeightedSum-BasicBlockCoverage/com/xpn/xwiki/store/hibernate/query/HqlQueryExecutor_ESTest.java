...
public class HqlQueryExecutor_ESTest extends HqlQueryExecutor_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      DefaultQuery defaultQuery0 = new DefaultQuery("height", "height", hqlQueryExecutor0);
      ...
      ScriptQuery scriptQuery0 = new ScriptQuery(secureQuery0, embeddableComponentManager0);
      QueryParameter queryParameter0 = defaultQuery0.bindValue((String) null);
      ScriptQueryParameter scriptQueryParameter0 = new ScriptQueryParameter(scriptQuery0, queryParameter0);
      SessionImplementor sessionImplementor0 = mock(SessionImplementor.class, new ViolatedAssumptionAnswer());
      ConcurrentSkipListMap<ScriptQuery, DefaultQueryParameter> concurrentSkipListMap0 = new ConcurrentSkipListMap<ScriptQuery, DefaultQueryParameter>();
      ParameterMetadata parameterMetadata0 = new ParameterMetadata((OrdinalParameterDescriptor[]) null, concurrentSkipListMap0);
      CollectionFilterImpl collectionFilterImpl0 = new CollectionFilterImpl("height", scriptQueryParameter0, sessionImplementor0, parameterMetadata0);
      Query query0 = collectionFilterImpl0.setComment((String) null);
      // Undeclared exception!
      hqlQueryExecutor0.populateParameters(query0, scriptQuery0);
  }
}
