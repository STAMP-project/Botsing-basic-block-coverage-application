...
public class Parser_ESTest extends Parser_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ArrayList<ASingleConditionalExpression> arrayList0 = new ArrayList<ASingleConditionalExpression>();
      arrayList0.add((ASingleConditionalExpression) null);
      ArrayList<TLocate> arrayList1 = new ArrayList<TLocate>();
      arrayList0.add((ASingleConditionalExpression) null);
      StringReader stringReader0 = new StringReader("A:2OS{L!pNT{");
      PushbackReader pushbackReader0 = new PushbackReader(stringReader0);
      PushbackReader pushbackReader1 = new PushbackReader(pushbackReader0, 11);
