...
public class DirectSearchOptimizer_ESTest extends DirectSearchOptimizer_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      doubleArray0[1] = (-1760.2753161361);
      GoalType goalType0 = GoalType.MAXIMIZE;
      multiDirectional0.setMaxIterations((-2001));
      GoalType goalType1 = GoalType.MINIMIZE;
      try { 
        multiDirectional0.optimize(multivariateRealFunction0, goalType1, doubleArray0);
        fail("Expecting exception: OptimizationException");
      
      } catch(OptimizationException e) {
         //
         // org.apache.commons.math.MaxIterationsExceededException: Maximal number of iterations (-2,001) exceeded
         //
