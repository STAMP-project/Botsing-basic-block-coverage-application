...
public class HqlQueryExecutor_ESTest extends HqlQueryExecutor_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      hqlQueryExecutor0.completeShortFormStatement("__v7rp");
      EmbeddableComponentManager embeddableComponentManager0 = new EmbeddableComponentManager();
      AtomicHashMap<String, DocumentComponentManager> atomicHashMap0 = new AtomicHashMap<String, DocumentComponentManager>();
      atomicHashMap0.copy();
      atomicHashMap0.copy();
      ...
      CollectionFilterImpl collectionFilterImpl0 = new CollectionFilterImpl("04Kr;>L`Y", integer0, sessionImplementor0, parameterMetadata0);
      DefaultTableModel defaultTableModel0 = new DefaultTableModel();
      Query query0 = collectionFilterImpl0.setProperties((Object) defaultTableModel0);
      // Undeclared exception!
      hqlQueryExecutor0.setNamedParameter(query0, "?F!rVpufmCzFqh@lu", parameterMetadata0);
  }
}
