...
public class XWQLtoHQLTranslator_ESTest extends XWQLtoHQLTranslator_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      DocumentAccessBridge documentAccessBridge0 = xWQLtoHQLTranslator0.getDocumentAccessBridge();
      Start start0 = new Start();
      QueryContext queryContext0 = new QueryContext(start0, documentAccessBridge0);
      ...
      Injector.inject(xWQLtoHQLTranslator1, (Class<?>) XWQLtoHQLTranslator.class, "documentAccessBridge", (Object) documentAccessBridge0);
      Injector.validateBean(xWQLtoHQLTranslator1, (Class<?>) XWQLtoHQLTranslator.class);
      xWQLtoHQLTranslator1.getOutputLanguage();
      xWQLtoHQLTranslator1.getPrinter(queryContext0);
      try { 
