...
public class DefaultContentParser_ESTest extends DefaultContentParser_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      EntityReferenceSerializer<PlainTextBlockParser> entityReferenceSerializer1 = (EntityReferenceSerializer<PlainTextBlockParser>) mock(EntityReferenceSerializer.class, new ViolatedAssumptionAnswer());
      ...
      SyntaxType syntaxType0 = SyntaxType.APT;
      Syntax syntax0 = new Syntax(syntaxType0, "`%gfqW^iG9g[EfY~", "`%gfqW^iG9g[EfY~");
      LocalDocumentReference localDocumentReference0 = (LocalDocumentReference)XWikiDocument.COMMENTSCLASS_REFERENCE;
      // Undeclared exception!
      defaultContentParser1.parse("`%gfqW^iG9g[EfY~", syntax0, (EntityReference) localDocumentReference0);
  }
}
