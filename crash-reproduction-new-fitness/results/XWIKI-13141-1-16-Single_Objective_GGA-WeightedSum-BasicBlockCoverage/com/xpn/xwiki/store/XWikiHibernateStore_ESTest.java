...
public class XWikiHibernateStore_ESTest extends XWikiHibernateStore_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      XWikiHibernateStore xWikiHibernateStore0 = new XWikiHibernateStore("grant resource to ");
      EntityReferenceSerializer<StringProperty> entityReferenceSerializer0 = (EntityReferenceSerializer<StringProperty>) mock(EntityReferenceSerializer.class, new ViolatedAssumptionAnswer());
      ...
      DocumentReferenceResolver<DoubleProperty> documentReferenceResolver0 = (DocumentReferenceResolver<DoubleProperty>) mock(DocumentReferenceResolver.class, new ViolatedAssumptionAnswer());
      ...
      DocumentReferenceResolver<StringListProperty> documentReferenceResolver1 = (DocumentReferenceResolver<StringListProperty>) mock(DocumentReferenceResolver.class, new ViolatedAssumptionAnswer());
      ...
      EntityReferenceSerializer<MigrationRequiredException> entityReferenceSerializer1 = (EntityReferenceSerializer<MigrationRequiredException>) mock(EntityReferenceSerializer.class, new ViolatedAssumptionAnswer());
      ...
      EntityReferenceSerializer<XWikiDocument.XWikiAttachmentToRemove> entityReferenceSerializer2 = (EntityReferenceSerializer<XWikiDocument.XWikiAttachmentToRemove>) mock(EntityReferenceSerializer.class, new ViolatedAssumptionAnswer());
      ...
      try { 
        xWikiHibernateStore0.saveXWikiDoc(xWikiDocument0, xWikiContext2, false);
