...
public class CountDocumentFilter_ESTest extends CountDocumentFilter_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      countDocumentFilter2.filterStatement("i)K^>mxqM]#&V8{e", "i)K^>mxqM]#&V8{e");
      countDocumentFilter2.filterStatement("4fulFm/u", "&X7*y3!U&Vf]>W5d");
      LinkedList<Object> linkedList0 = new LinkedList<Object>();
      countDocumentFilter0.filterResults(linkedList0);
      countDocumentFilter1.filterStatement("Fg`^7)^H", "Fg`^7)^H");
      LinkedList<Object> linkedList1 = new LinkedList<Object>();
      countDocumentFilter1.filterResults(linkedList1);
      // Undeclared exception!
      countDocumentFilter2.filterStatement("zfK", "hql");
  }
}
