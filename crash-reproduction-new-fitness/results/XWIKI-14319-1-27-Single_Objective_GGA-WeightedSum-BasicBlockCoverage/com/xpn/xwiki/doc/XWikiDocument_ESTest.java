...
public class XWikiDocument_ESTest extends XWikiDocument_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      xWikiDocument0.setxWikiClassXML("wBB, }.");
      ...
      doReturn((String) null).when(editForm0).getContent();
      doReturn((String) null).when(editForm0).getTitle();
      XWikiContext xWikiContext0 = new XWikiContext();
      xWikiDocument0.readTranslationMetaFromForm(editForm0, xWikiContext0);
