...
public class EmptyBlockChainingListener_ESTest extends EmptyBlockChainingListener_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      emptyBlockChainingListener0.beginDefinitionList(map0);
      ...
      doReturn((ChainingListener) null, (ChainingListener) null).when(listenerChain2).getNextListener(nullable(java.lang.Class.class));
      emptyBlockChainingListener0.setListenerChain(listenerChain2);
      Map<String, String> map1 = Listener.EMPTY_PARAMETERS;
      emptyBlockChainingListener0.endMacroMarker((String) null, map1, (String) null, false);
      Format format1 = Format.STRIKEDOUT;
      // Undeclared exception!
      emptyBlockChainingListener0.endFormat(format1, map1);
  }
}
