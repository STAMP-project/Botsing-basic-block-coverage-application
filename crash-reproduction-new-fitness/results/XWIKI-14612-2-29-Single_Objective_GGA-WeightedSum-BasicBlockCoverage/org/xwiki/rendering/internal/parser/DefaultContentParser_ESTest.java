...
public class DefaultContentParser_ESTest extends DefaultContentParser_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      Provider<XWiki20Parser> provider1 = (Provider<XWiki20Parser>) mock(Provider.class, new ViolatedAssumptionAnswer());
      Injector.inject(defaultContentParser1, (Class<?>) DefaultContentParser.class, "componentManagerProvider", (Object) provider1);
      EntityReferenceSerializer<PygmentsParser> entityReferenceSerializer1 = (EntityReferenceSerializer<PygmentsParser>) mock(EntityReferenceSerializer.class, new ViolatedAssumptionAnswer());
      ...
      defaultContentParser0.parse("|K<zFq9-V h'0m", syntax0, entityReference0);
  }
}
