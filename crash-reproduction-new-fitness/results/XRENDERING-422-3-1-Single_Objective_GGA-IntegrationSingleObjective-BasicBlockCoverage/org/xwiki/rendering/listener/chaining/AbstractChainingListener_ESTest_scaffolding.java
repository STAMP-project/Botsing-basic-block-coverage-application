...
public class AbstractChainingListener_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("org.xwiki.rendering.listener.chaining.ListenerChain", false, AbstractChainingListener_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.xwiki.rendering.listener.reference.ResourceReference", false, AbstractChainingListener_ESTest_scaffolding.class.getClassLoader()));
  }
}
