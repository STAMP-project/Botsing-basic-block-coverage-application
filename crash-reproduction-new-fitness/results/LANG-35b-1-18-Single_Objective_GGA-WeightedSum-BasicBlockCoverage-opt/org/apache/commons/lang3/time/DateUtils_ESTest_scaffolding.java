...
public class DateUtils_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.util.Calendar", false, DateUtils_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.Date", false, DateUtils_ESTest_scaffolding.class.getClassLoader()));
  }
}
