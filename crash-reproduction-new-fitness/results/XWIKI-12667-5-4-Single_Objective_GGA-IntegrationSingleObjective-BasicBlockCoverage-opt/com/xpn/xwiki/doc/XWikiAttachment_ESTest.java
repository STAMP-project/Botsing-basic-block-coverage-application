...
public class XWikiAttachment_ESTest extends XWikiAttachment_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      doReturn((DocumentReference) null, (DocumentReference) null, (DocumentReference) null).when(xWikiDocument0).getDocumentReference();
      xWikiAttachment0.setDoc(xWikiDocument0);
      XWikiContext xWikiContext0 = new XWikiContext();
      xWikiAttachment0.loadArchive(xWikiContext0);
      Archive archive0 = mock(Archive.class, new ViolatedAssumptionAnswer());
      xWikiAttachment0.setArchive(archive0);
      xWikiAttachment0.setAuthor("M-'=S!");
