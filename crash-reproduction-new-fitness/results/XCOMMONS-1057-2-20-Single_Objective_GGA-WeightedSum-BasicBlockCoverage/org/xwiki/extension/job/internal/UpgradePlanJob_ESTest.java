...
public class UpgradePlanJob_ESTest extends UpgradePlanJob_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      Provider<InstallRequest> provider0 = (Provider<InstallRequest>) mock(Provider.class, new ViolatedAssumptionAnswer());
      Injector.inject(upgradePlanJob0, (Class<?>) AbstractJob.class, "executionContextManagerProvider", (Object) provider0);
      Provider<DefaultVersion> provider1 = (Provider<DefaultVersion>) mock(Provider.class, new ViolatedAssumptionAnswer());
      ...
      doReturn((Job) null).when(jobContext0).getCurrentJob();
      ...
      defaultRequest0.setProperty("", upgradePlanJob0);
      upgradePlanJob0.initialize(defaultRequest0);
