...
public class DirectSearchOptimizer_ESTest extends DirectSearchOptimizer_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      SimpleScalarValueChecker simpleScalarValueChecker0 = new SimpleScalarValueChecker((-2185), 0.0);
      multiDirectional0.setMaxIterations((-2185));
      ...
      try { 
        ...
        fail("Expecting exception: OptimizationException");
         ...
         //
         // org.apache.commons.math.MaxIterationsExceededException: Maximal number of iterations (-2,185) exceeded
         //
