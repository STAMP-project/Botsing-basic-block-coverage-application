...
public class MultiDirectional_ESTest extends MultiDirectional_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      MultiDirectional multiDirectional0 = new MultiDirectional((-810.5), 1089.11843);
      SimpleRealPointChecker simpleRealPointChecker0 = new SimpleRealPointChecker(548.017425, (-745.665));
      multiDirectional0.setConvergenceChecker(simpleRealPointChecker0);
      multiDirectional0.setMaxIterations((-153));
      try { 
        ...
        fail("Expecting exception: OptimizationException");
         ...
         //
         // org.apache.commons.math.MaxIterationsExceededException: Maximal number of iterations (-153) exceeded
         //
