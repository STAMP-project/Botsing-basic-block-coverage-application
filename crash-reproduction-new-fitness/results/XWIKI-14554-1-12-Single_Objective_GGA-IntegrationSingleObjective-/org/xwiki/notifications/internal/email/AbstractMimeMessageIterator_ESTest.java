...
public class AbstractMimeMessageIterator_ESTest extends AbstractMimeMessageIterator_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      EntityReferenceSerializer<FlagsUUID> entityReferenceSerializer0 = (EntityReferenceSerializer<FlagsUUID>) mock(EntityReferenceSerializer.class, new ViolatedAssumptionAnswer());
      ...
      SubstituteLogger substituteLogger0 = new SubstituteLogger("<3HO{`", (Queue<SubstituteLoggingEvent>) null, false);
      ...
      doReturn((Object) null, (Object) null).when(configurationSource0).getProperty(anyString() , nullable(java.lang.Class.class));
      ...
      doReturn((Object) null, (Object) null).when(configurationSource1).getProperty(anyString() , nullable(java.lang.Object.class));
      ...
      doReturn((Object) null, (Object) null).when(configurationSource2).getProperty(anyString() , nullable(java.lang.Class.class));
      ...
      defaultMailSenderConfiguration0.getUsername();
