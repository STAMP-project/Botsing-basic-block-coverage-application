...
public class HqlQueryExecutor_ESTest extends HqlQueryExecutor_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      AtomicHashMap<NamedSQLQueryDefinition, ContextComponentManager> atomicHashMap0 = new AtomicHashMap<NamedSQLQueryDefinition, ContextComponentManager>(true, atomicHashMap_ProxyMode0);
      ParameterMetadata parameterMetadata0 = new ParameterMetadata((OrdinalParameterDescriptor[]) null, atomicHashMap0);
      CollectionFilterImpl collectionFilterImpl0 = new CollectionFilterImpl("O;^#fm}`]+{'%iMS) ", hqlQueryExecutor0, (SessionImplementor) null, parameterMetadata0);
      Query query0 = collectionFilterImpl0.setReadOnly(true);
      // Undeclared exception!
      hqlQueryExecutor0.setNamedParameter(query0, "O;^#fm}`]+{'%iMS) ", "O;^#fm}`]+{'%iMS) ");
  }
}
