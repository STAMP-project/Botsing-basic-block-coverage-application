...
public class PolyhedronsSet$FacetsContributionVisitor_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.text.Format$Field", false, PolyhedronsSet$FacetsContributionVisitor_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.apache.commons.math3.geometry.partitioning.BSPTree", false, PolyhedronsSet$FacetsContributionVisitor_ESTest_scaffolding.class.getClassLoader()));
  }
}
