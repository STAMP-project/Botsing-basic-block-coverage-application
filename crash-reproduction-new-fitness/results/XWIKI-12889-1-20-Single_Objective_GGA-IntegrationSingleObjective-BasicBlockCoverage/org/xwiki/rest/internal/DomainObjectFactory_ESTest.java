...
public class DomainObjectFactory_ESTest extends DomainObjectFactory_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      Injector.inject(defaultLoggerManager1, (Class<?>) DefaultLoggerManager.class, "logger", (Object) logger0);
      ...
      DefaultRequest defaultRequest3 = new DefaultRequest(defaultRequest1);
      JobStatus jobStatus0 = mock(JobStatus.class, new ViolatedAssumptionAnswer());
      DefaultJobStatus<DefaultRequest> defaultJobStatus0 = new DefaultJobStatus<DefaultRequest>(defaultRequest3, jobStatus0, defaultObservationManager0, defaultLoggerManager1);
      JobStatus jobStatus1 = defaultJobStatus0.getParentJobStatus();
      DefaultJobStatus<DefaultRequest> defaultJobStatus1 = new DefaultJobStatus<DefaultRequest>(defaultRequest0, jobStatus1, defaultObservationManager0, defaultLoggerManager1);
      defaultJobStatus1.getParentJobStatus();
      ObjectFactory objectFactory0 = new ObjectFactory();
      URI uRI0 = new URI((String) null, "", "highlight", (String) null, (String) null);
