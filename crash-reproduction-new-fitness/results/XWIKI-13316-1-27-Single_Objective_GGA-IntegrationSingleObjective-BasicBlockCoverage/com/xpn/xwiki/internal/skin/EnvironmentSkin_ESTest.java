...
public class EnvironmentSkin_ESTest extends EnvironmentSkin_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      doReturn((Skin) null, (Skin) null).when(internalSkinManager0).getSkin(anyString());
      InternalSkinConfiguration internalSkinConfiguration0 = mock(InternalSkinConfiguration.class, new ViolatedAssumptionAnswer());
      doReturn((String) null, (String) null).when(internalSkinConfiguration0).getDefaultParentSkinId();
      ...
      doReturn((URL) null, (URL) null).when(environment0).getResource(anyString());
      ...
      EnvironmentSkin environmentSkin1 = new EnvironmentSkin("", internalSkinManager1, internalSkinConfiguration1, logger1, syntaxFactory1, (Environment) null, (Provider<XWikiContext>) null);
