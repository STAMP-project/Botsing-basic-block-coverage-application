...
public class MultiDirectional_ESTest extends MultiDirectional_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      double double0 = 0.0;
      MultiDirectional multiDirectional0 = new MultiDirectional(0.0, 773.941035);
      multiDirectional0.getIterations();
      multiDirectional0.getMaxIterations();
      int int0 = (-2220);
      multiDirectional0.setMaxIterations((-2220));
      ...
      try { 
        ...
        fail("Expecting exception: OptimizationException");
         ...
         //
         // org.apache.commons.math.MaxIterationsExceededException: Maximal number of iterations (-2,220) exceeded
         //
