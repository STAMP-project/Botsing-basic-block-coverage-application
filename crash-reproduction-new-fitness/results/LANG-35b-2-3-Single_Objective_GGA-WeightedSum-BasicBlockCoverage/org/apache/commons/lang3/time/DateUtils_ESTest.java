...
public class DateUtils_ESTest extends DateUtils_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      DateUtils.isSameInstant(date1, date1);
      Date date2 = mock(Date.class, new ViolatedAssumptionAnswer());
      doReturn(0L).when(date2).getTime();
      Date date3 = DateUtils.addMonths(date2, 45);
      DateUtils.addYears(date3, (-1812));
      String[] stringArray0 = new String[0];
      try { 
        DateUtils.parseDate("w/t=", stringArray0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Unable to parse the date: w/t=
         //
