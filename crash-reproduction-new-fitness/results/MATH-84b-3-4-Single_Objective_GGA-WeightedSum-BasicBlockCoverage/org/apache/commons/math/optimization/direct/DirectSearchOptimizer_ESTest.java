...
public class DirectSearchOptimizer_ESTest extends DirectSearchOptimizer_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      doubleArray0[0] = (-763.6324028420357);
      doubleArray0[5] = (-234.0);
      NelderMead nelderMead0 = new NelderMead();
      nelderMead0.getMaxEvaluations();
      MultiDirectional multiDirectional0 = new MultiDirectional(1467.35605633, 0.0);
      multiDirectional0.setMaxIterations((-356));
      ...
      try { 
        ...
        fail("Expecting exception: OptimizationException");
         ...
         //
         // org.apache.commons.math.MaxIterationsExceededException: Maximal number of iterations (-356) exceeded
         //
