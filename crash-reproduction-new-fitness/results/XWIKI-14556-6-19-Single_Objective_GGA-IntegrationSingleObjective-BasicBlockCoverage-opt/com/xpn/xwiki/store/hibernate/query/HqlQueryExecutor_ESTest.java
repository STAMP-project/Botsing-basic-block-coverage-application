...
public class HqlQueryExecutor_ESTest extends HqlQueryExecutor_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      HqlQueryExecutor.isSafeSelect(", ");
      HqlQueryExecutor.isSafeSelect("r$Jo_Uz+st3l<H'");
      DefaultQuery defaultQuery0 = new DefaultQuery("Could not determine a type for class: ", "v@p#d`^8r", hqlQueryExecutor0);
      SubstituteLoggingEvent substituteLoggingEvent0 = new SubstituteLoggingEvent();
      defaultQuery0.bindValue("order by |}cky<s>tr5jp&j$0r", (Object) substituteLoggingEvent0);
      OrdinalParameterDescriptor[] ordinalParameterDescriptorArray0 = new OrdinalParameterDescriptor[2];
      TextType textType0 = TextType.INSTANCE;
      OrdinalParameterDescriptor ordinalParameterDescriptor0 = new OrdinalParameterDescriptor(335, textType0, 335);
      ordinalParameterDescriptorArray0[0] = ordinalParameterDescriptor0;
      OrdinalParameterDescriptor ordinalParameterDescriptor1 = new OrdinalParameterDescriptor((-1056), textType0, (-412008634));
      ...
      CollectionFilterImpl collectionFilterImpl0 = new CollectionFilterImpl("order by v@p#d`^8r", hqlQueryExecutor0, (SessionImplementor) null, parameterMetadata0);
      LockMode lockMode0 = LockMode.UPGRADE;
      Query query0 = collectionFilterImpl0.setLockMode("order by v@p#d`^8r", lockMode0);
