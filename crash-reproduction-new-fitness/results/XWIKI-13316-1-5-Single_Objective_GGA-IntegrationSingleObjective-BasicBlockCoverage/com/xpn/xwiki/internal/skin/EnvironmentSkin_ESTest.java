...
public class EnvironmentSkin_ESTest extends EnvironmentSkin_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      EnvironmentSkin environmentSkin0 = new EnvironmentSkin("Searching for the user in LDAP: user [{}] base [{}] query [{}] uid [{}]", internalSkinManager0, internalSkinConfiguration0, logger0, syntaxFactory0, (Environment) null, provider0);
