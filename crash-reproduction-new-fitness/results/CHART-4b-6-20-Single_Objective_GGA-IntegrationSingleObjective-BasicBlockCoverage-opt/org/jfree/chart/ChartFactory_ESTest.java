...
public class ChartFactory_ESTest extends ChartFactory_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      ChartFactory.createStackedBarChart3D("$[?TYS= ~!_UG3F\"x+", (String) null, "$[?TYS= ~!_UG3F\"x+", categoryDataset0, plotOrientation0, true, false, true);
      ...
      ChartFactory.createScatterPlot("$[?TYS= ~!_UG3F\"x+", "$[?TYS= ~!_UG3F\"x+", "$[?TYS= ~!_UG3F\"x+", xYDataset0, plotOrientation1, false, true, true);
  }
}
