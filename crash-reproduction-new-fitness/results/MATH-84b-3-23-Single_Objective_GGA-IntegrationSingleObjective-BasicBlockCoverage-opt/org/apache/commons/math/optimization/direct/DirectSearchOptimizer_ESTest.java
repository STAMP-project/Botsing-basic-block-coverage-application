...
public class DirectSearchOptimizer_ESTest extends DirectSearchOptimizer_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      multiDirectional0.setMaxIterations((-1119));
      multiDirectional0.getMaxIterations();
      multiDirectional0.getEvaluations();
      NelderMead nelderMead0 = new NelderMead(3225.302, 1839.516726, (-2974.3828), 1839.516726);
      ...
      try { 
        ...
        fail("Expecting exception: OptimizationException");
         ...
         //
         // org.apache.commons.math.MaxIterationsExceededException: Maximal number of iterations (-1,119) exceeded
         //
