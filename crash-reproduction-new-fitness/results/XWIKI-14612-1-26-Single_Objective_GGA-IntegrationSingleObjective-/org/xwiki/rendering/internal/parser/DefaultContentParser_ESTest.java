...
public class DefaultContentParser_ESTest extends DefaultContentParser_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      Provider<CreoleParser> provider1 = (Provider<CreoleParser>) mock(Provider.class, new ViolatedAssumptionAnswer());
      Injector.inject(defaultContentParser1, (Class<?>) DefaultContentParser.class, "componentManagerProvider", (Object) provider1);
      EntityReferenceSerializer<EmbeddableComponentManager> entityReferenceSerializer1 = (EntityReferenceSerializer<EmbeddableComponentManager>) mock(EntityReferenceSerializer.class, new ViolatedAssumptionAnswer());
