...
public class HqlQueryExecutor_ESTest extends HqlQueryExecutor_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      DefaultQuery defaultQuery0 = new DefaultQuery("b~m", "Named queries requires programming right", hqlQueryExecutor0);
      defaultQuery0.checkCurrentUser(true);
      Query query0 = defaultQuery0.setOffset((-2533));
      ...
      linkedTransferQueue0.offer(substituteLoggingEvent0);
      SubstituteLogger substituteLogger0 = new SubstituteLogger("Named queries requires programming right", linkedTransferQueue0, true);
      ...
      countDocumentFilter0.filterStatement("query.hql.progress.execute", "Named queries requires programming right");
