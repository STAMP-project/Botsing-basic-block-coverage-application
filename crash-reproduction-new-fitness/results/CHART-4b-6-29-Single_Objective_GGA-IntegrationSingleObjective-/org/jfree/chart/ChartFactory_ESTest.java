...
public class ChartFactory_ESTest extends ChartFactory_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      ChartFactory.createPieChart3D("", pieDataset0, true, true, true);
      String string0 = "1<0V'L";
      VectorSeriesCollection vectorSeriesCollection0 = new VectorSeriesCollection();
      PlotOrientation plotOrientation0 = mock(PlotOrientation.class, new ViolatedAssumptionAnswer());
      // Undeclared exception!
      ChartFactory.createScatterPlot("1<0V'L", "", "<J#R", vectorSeriesCollection0, plotOrientation0, true, true, true);
  }
}
