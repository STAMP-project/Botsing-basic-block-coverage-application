...
public class DirectSearchOptimizer_ESTest extends DirectSearchOptimizer_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      NelderMead nelderMead0 = new NelderMead((-1564.3673270977), (-1564.3673270977), (-1564.3673270977), (-1564.3673270977));
      ...
      nelderMead0.setMaxIterations((-3979));
      nelderMead0.setConvergenceChecker(simpleScalarValueChecker0);
      ...
      try { 
        ...
        fail("Expecting exception: OptimizationException");
         ...
         //
         // org.apache.commons.math.MaxIterationsExceededException: Maximal number of iterations (-3,979) exceeded
         //
