...
public class DateTimeFormatter_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.io.Writer", false, DateTimeFormatter_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.joda.time.Chronology", false, DateTimeFormatter_ESTest_scaffolding.class.getClassLoader()));
