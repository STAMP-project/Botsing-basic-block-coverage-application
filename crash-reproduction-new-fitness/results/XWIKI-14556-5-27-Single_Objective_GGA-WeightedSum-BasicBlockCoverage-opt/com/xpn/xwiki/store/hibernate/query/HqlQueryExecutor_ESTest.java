...
public class HqlQueryExecutor_ESTest extends HqlQueryExecutor_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      Hashtable<ContextRootComponentManager, Object> hashtable0 = new Hashtable<ContextRootComponentManager, Object>();
      ParameterMetadata parameterMetadata0 = new ParameterMetadata((OrdinalParameterDescriptor[]) null, hashtable0);
      CollectionFilterImpl collectionFilterImpl0 = new CollectionFilterImpl("CHECK", jobProgressManager0, (SessionImplementor) null, parameterMetadata0);
      LockOptions lockOptions0 = collectionFilterImpl0.getLockOptions();
      LockMode.parse("CHECK");
      LockOptions lockOptions1 = lockOptions0.setAliasSpecificLockMode("'@-KTAQs~da@", (LockMode) null);
      Query query0 = collectionFilterImpl0.setLockOptions(lockOptions1);
      // Undeclared exception!
      hqlQueryExecutor0.setNamedParameter(query0, "'@-KTAQs~da@", "'@-KTAQs~da@");
  }
}
