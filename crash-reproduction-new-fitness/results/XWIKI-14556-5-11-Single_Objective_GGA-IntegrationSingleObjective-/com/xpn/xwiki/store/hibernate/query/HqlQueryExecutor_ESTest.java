...
public class HqlQueryExecutor_ESTest extends HqlQueryExecutor_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      ConcurrentSkipListMap<HijrahDate, RootComponentManager> concurrentSkipListMap0 = new ConcurrentSkipListMap<HijrahDate, RootComponentManager>();
      ParameterMetadata parameterMetadata0 = new ParameterMetadata((OrdinalParameterDescriptor[]) null, concurrentSkipListMap0);
      CollectionFilterImpl collectionFilterImpl0 = new CollectionFilterImpl("F9X3cQ Z?!", hqlQueryExecutor0, sessionImplementor0, parameterMetadata0);
      Query query0 = collectionFilterImpl0.setTimeout(2003);
      // Undeclared exception!
      hqlQueryExecutor0.setNamedParameter(query0, "not all n", "F9X3cQ Z?!");
  }
}
