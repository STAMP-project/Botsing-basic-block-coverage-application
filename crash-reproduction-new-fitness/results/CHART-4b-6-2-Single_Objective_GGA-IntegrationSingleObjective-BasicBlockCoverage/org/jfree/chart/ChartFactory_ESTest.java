...
public class ChartFactory_ESTest extends ChartFactory_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      ChartFactory.createHighLowChart("", "", "", oHLCDataset0, timeline0, true);
      XYDataset xYDataset0 = mock(XYDataset.class, new ViolatedAssumptionAnswer());
      doReturn((DatasetGroup) null).when(xYDataset0).getGroup();
      doReturn(0, 0).when(xYDataset0).getSeriesCount();
      boolean boolean0 = false;
      boolean boolean1 = true;
      ChartFactory.createPolarChart("", xYDataset0, false, true, false);
      ...
      ChartFactory.createScatterPlot("", "H|SFDfa@:/i*N=", "", xYDataset1, plotOrientation0, false, false, false);
  }
}
