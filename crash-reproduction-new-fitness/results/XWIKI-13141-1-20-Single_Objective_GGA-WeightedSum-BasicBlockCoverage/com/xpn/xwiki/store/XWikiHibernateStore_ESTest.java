...
public class XWikiHibernateStore_ESTest extends XWikiHibernateStore_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      String string0 = "Creation of a new database is currently only supported in the schema mode, see http://jira.xwiki.org/browse/XWIKI-8753";
      XWikiHibernateStore xWikiHibernateStore0 = new XWikiHibernateStore("Creation of a new database is currently only supported in the schema mode, see http://jira.xwiki.org/browse/XWIKI-8753");
      EntityReferenceSerializer<XWikiDocument.XWikiAttachmentToRemove> entityReferenceSerializer0 = (EntityReferenceSerializer<XWikiDocument.XWikiAttachmentToRemove>) mock(EntityReferenceSerializer.class, new ViolatedAssumptionAnswer());
      ...
      EntityReferenceSerializer<SpaceReference> entityReferenceSerializer1 = (EntityReferenceSerializer<SpaceReference>) mock(EntityReferenceSerializer.class, new ViolatedAssumptionAnswer());
      ...
      Provider<LargeStringProperty> provider0 = (Provider<LargeStringProperty>) mock(Provider.class, new ViolatedAssumptionAnswer());
