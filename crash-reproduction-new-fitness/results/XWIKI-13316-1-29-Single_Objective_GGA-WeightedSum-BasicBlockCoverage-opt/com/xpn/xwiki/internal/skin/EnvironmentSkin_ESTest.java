...
public class EnvironmentSkin_ESTest extends EnvironmentSkin_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      EnvironmentSkin environmentSkin0 = new EnvironmentSkin("5e&[Mh", (InternalSkinManager) null, internalSkinConfiguration0, logger0, syntaxFactory0, environment0, provider0);
      environmentSkin0.createResource("d<)e+TzM().1]8>D7", "d<)e+TzM().1]8>D7");
      ...
      EnvironmentSkin environmentSkin1 = new EnvironmentSkin("],XzCpO]sK", (InternalSkinManager) null, internalSkinConfiguration1, logger1, syntaxFactory1, (Environment) null, provider1);
