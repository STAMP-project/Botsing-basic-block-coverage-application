...
public class EnvironmentSkin_ESTest extends EnvironmentSkin_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      EnvironmentSkin environmentSkin0 = new EnvironmentSkin("", (InternalSkinManager) null, internalSkinConfiguration0, logger0, syntaxFactory0, (Environment) null, provider0);
      environmentSkin0.getId();
      String string0 = "{j&s+7T6t";
      environmentSkin0.createResource("Item{version=", "{j&s+7T6t");
      ...
      EnvironmentSkin environmentSkin1 = new EnvironmentSkin((String) null, (InternalSkinManager) null, internalSkinConfiguration1, logger1, syntaxFactory1, (Environment) null, provider1);
