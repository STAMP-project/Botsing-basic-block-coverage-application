...
public class AbstractInstallPlanJob$ModifableExtensionPlanTree_ESTest extends AbstractInstallPlanJob$ModifableExtensionPlanTree_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      DefaultExtensionPlanAction defaultExtensionPlanAction0 = new DefaultExtensionPlanAction((Extension) null, linkedList0, extensionPlanAction_Action0, "ryoC^ps& {8vXl?QRb", false);
      PriorityQueue<VersionRangeCollection> priorityQueue0 = new PriorityQueue<VersionRangeCollection>();
      DefaultVersion defaultVersion0 = new DefaultVersion("ryoC^ps& {8vXl?QRb");
      DefaultVersion defaultVersion1 = new DefaultVersion(defaultVersion0);
      DefaultVersionConstraint defaultVersionConstraint0 = new DefaultVersionConstraint(priorityQueue0, defaultVersion1);
