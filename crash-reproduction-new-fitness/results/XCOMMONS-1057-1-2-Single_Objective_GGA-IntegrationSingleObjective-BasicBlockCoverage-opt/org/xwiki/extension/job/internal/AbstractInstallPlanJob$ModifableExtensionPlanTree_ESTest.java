...
public class AbstractInstallPlanJob$ModifableExtensionPlanTree_ESTest extends AbstractInstallPlanJob$ModifableExtensionPlanTree_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      DefaultVersion defaultVersion0 = new DefaultVersion("d.l8r4x{");
      ExtensionId extensionId0 = new ExtensionId("Unsupported name: has scheme but relative path-part", defaultVersion0);
      EmptyExtension emptyExtension0 = new EmptyExtension(extensionId0, "'D)]RO_[]Z *3-KpB");
      ...
      DefaultExtensionPlanAction defaultExtensionPlanAction0 = new DefaultExtensionPlanAction(emptyExtension0, priorityQueue0, extensionPlanAction_Action0, "EZ->Hdxg%{~", false);
      DefaultVersionConstraint defaultVersionConstraint0 = new DefaultVersionConstraint("'D)]RO_[]Z *3-KpB");
