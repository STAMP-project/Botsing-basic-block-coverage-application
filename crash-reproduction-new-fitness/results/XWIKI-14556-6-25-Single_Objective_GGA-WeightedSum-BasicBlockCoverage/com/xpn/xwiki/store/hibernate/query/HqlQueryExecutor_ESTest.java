...
public class HqlQueryExecutor_ESTest extends HqlQueryExecutor_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      EvictionType evictionType0 = EvictionType.COUNT;
      org.xwiki.query.Query query1 = defaultQuery0.bindValue("~", (Object) evictionType0);
      hqlQueryExecutor0.populateParameters(query0, query1);
      SessionImplementor sessionImplementor0 = mock(SessionImplementor.class, new ViolatedAssumptionAnswer());
      ConcurrentSkipListMap<WikiComponentManager, EmbeddableComponentManager> concurrentSkipListMap0 = new ConcurrentSkipListMap<WikiComponentManager, EmbeddableComponentManager>();
      ...
      FlushMode.parse("sql");
      Query query2 = collectionFilterImpl0.setFlushMode((FlushMode) null);
      // Undeclared exception!
      hqlQueryExecutor0.populateParameters(query2, defaultQuery0);
  }
}
