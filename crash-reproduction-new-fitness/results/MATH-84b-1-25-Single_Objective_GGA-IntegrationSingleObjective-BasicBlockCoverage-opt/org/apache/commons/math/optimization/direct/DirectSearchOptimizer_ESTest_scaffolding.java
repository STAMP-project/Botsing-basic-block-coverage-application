...
public class DirectSearchOptimizer_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.util.Comparator", false, DirectSearchOptimizer_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.apache.commons.math.analysis.MultivariateVectorialFunction", false, DirectSearchOptimizer_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.apache.commons.math.optimization.RealConvergenceChecker", false, DirectSearchOptimizer_ESTest_scaffolding.class.getClassLoader()));
  }
}
