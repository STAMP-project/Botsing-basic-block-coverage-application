...
public class HqlQueryExecutor_ESTest extends HqlQueryExecutor_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      Hashtable<NoOpQueryFilter, WikiComponentManager> hashtable0 = new Hashtable<NoOpQueryFilter, WikiComponentManager>();
      ParameterMetadata parameterMetadata0 = new ParameterMetadata(ordinalParameterDescriptorArray0, hashtable0);
      CollectionFilterImpl collectionFilterImpl0 = new CollectionFilterImpl("delete one-to-many ", embeddableComponentManager0, sessionImplementor0, parameterMetadata0);
      collectionFilterImpl0.setCacheable(false);
      DefaultQuery defaultQuery0 = new DefaultQuery("No positional parameters in query: ", hqlQueryExecutor0);
      Query query0 = defaultQuery0.setOffset(1562);
      ...
      QueryParameter queryParameter0 = scriptQuery0.bindValue("d");
      ScriptQueryParameter scriptQueryParameter0 = new ScriptQueryParameter(scriptQuery0, queryParameter0);
      // Undeclared exception!
      hqlQueryExecutor0.setNamedParameter(collectionFilterImpl0, "delete one-to-many ", embeddableComponentManager0);
  }
}
