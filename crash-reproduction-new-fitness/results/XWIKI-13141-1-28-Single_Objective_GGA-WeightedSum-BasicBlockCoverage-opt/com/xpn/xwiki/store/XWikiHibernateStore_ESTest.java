...
public class XWikiHibernateStore_ESTest extends XWikiHibernateStore_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      XWikiHibernateStore xWikiHibernateStore0 = new XWikiHibernateStore("\"G:HL4*js%~Kr");
      EntityReferenceSerializer<XWikiAttachment> entityReferenceSerializer0 = (EntityReferenceSerializer<XWikiAttachment>) mock(EntityReferenceSerializer.class, new ViolatedAssumptionAnswer());
      ...
      DocumentReferenceResolver<SpaceReference> documentReferenceResolver1 = (DocumentReferenceResolver<SpaceReference>) mock(DocumentReferenceResolver.class, new ViolatedAssumptionAnswer());
