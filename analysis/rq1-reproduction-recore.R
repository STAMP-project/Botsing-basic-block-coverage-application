...
reproductionRateEffectSize$cat.alg1 <- ifelse(reproductionRateEffectSize$cat.alg1 == "IntegrationSingleObjective", "RecoreSTDistance",
                                              ifelse(reproductionRateEffectSize$cat.alg1 == "IntegrationSingleObjective-bb", "RecoreSTDistance+BBC","RecoreSTDistance+OPTBBC"))
...
reproductionRateEffectSize$cat.alg2 <- ifelse(reproductionRateEffectSize$cat.alg2 == "IntegrationSingleObjective", "RecoreSTDistance",
                                              ifelse(reproductionRateEffectSize$cat.alg2 == "IntegrationSingleObjective-bb", "RecoreSTDistance+BBC","RecoreSTDistance+OPTBBC"))

print(reproductionRateEffectSize)



effectiveness <- data.frame('Winner'=NA, 'RecoreSTDistance'=NA, 'RecoreSTDistance+BBC'=NA, 'RecoreSTDistance+OPTBBC'=NA)
...
resultsForReproductionCount$cat <- ifelse(resultsForReproductionCount$cat == "IntegrationSingleObjective","RecoreSTDistance",
                                          ifelse(resultsForReproductionCount$cat == "IntegrationSingleObjective-bb", "RecoreSTDistance+BBC","RecoreSTDistance+OPTBBC"))
...
onlyByBBC <- resultsForReproductionCount %>%
  ...
  filter((cat.alg1 == "RecoreSTDistance" | cat.alg1 == "RecoreSTDistance+BBC") & cat.alg2 == "RecoreSTDistance+OPTBBC" & count.alg1 == 0 & count.alg2 > 0)
